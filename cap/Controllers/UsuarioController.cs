...
/// <param name="authenticationService"></param>
        ...
        [HttpPut]
        [Route("")]
        public IActionResult Put(UsuarioViewModelOutput usuarioViewModelOutput)
        {
            var usuario = _usuarioRepository.ObterUsuario(usuarioViewModelOutput.Login);
            _usuarioRepository.Update(usuario.Login);
            _usuarioRepository.Commit();
